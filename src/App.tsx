        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6" id="nav-actions">
            ...
            <button
              ...
              className="border border-amber-600/40 bg-amber-500/10 text-amber-700 hover:bg-amber-500/20 px-3 py-2 text-[10px] font-mono uppercase tracking-wider font-semibold rounded transition-all flex items-center gap-1.5"
            >
              <Shield size={12} />
          ...
          <div className="md:hidden flex items-center space-x-4">
            <button 
              onClick={handleBookNowClick}
              className="bg-charcoal text-alabaster px-4 py-2 text-[10px] font-sans uppercase tracking-widest font-medium transition-transform active:scale-95"
            >
              Book
            </button>
            <button
