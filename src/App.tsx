        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <a href="#" className="flex flex-col group" id="brand-logo">
            ...
            <span className="text-[9px] uppercase tracking-[0.3em] font-sans text-charcoal/50 leading-none">
              BARBER SALON • EST. 1999
            </span>
          </a>

          {/* Desktop Navigation Links */}
          <nav className="hidden md:flex items-center space-x-12" id="desktop-menu">
          ...
          <div className="hidden md:flex items-center space-x-6" id="nav-actions">
            ...
            <button
              ...
              className="border border-amber-600/40 bg-amber-500/10 text-amber-700 hover:bg-amber-500/20 px-3 py-2 text-xs font-semibold tracking-wider font-mono uppercase tracking-wider font-semibold rounded transition-all flex items-center gap-1.5"
            >
              <Shield size={12} />
          ...
          <div className="md:hidden flex items-center space-x-4">
            <button 
              onClick={handleBookNowClick}
              className="bg-charcoal text-alabaster px-5 py-3 min-h-[44px] text-base font-semibold min-h-[44px] font-semibold tracking-wider font-sans uppercase tracking-widest font-medium transition-transform active:scale-95"
            >
              Book
            </button>
            <button
